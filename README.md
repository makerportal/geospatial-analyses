...
The NYC building footprint database is available for direct download via shapefile, here: https://data.cityofnewyork.us/api/geospatial/nqwf-w8eh?method=export&format=Shapefile. Keep in mind that the total uncompressed size of the file is ~2.25GB!
